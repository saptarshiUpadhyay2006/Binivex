...
const UserDropdown = ({ user, initialStocks, watchlistCount, watchlistSymbols }: {user: User, initialStocks: StockWithWatchlistStatus[], watchlistCount?: number, watchlistSymbols?: string[]}) => {
